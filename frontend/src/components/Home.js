                  ...
                  <ul className="mt-12">
                      ...
                      <a href="#" className="noti-item bg-menuDark">
                        <div className="pb-8 line-bt d-flex">
                          <p className="text-button fw-6">
                            Cointex to just tick size and trading amount
                            precision of spots/margins and perpetual swaps
                          </p>
                    ...
                    <li className="mt-12">
                      <a href="#" className="noti-item bg-menuDark">
                        ...
                        <span className="d-block mt-8 text-secondary">
                          1 day ago
                        </span>
                      </a>
                    </li>
